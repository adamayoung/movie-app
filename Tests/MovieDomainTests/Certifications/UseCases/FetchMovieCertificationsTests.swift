//
//  FetchMovieCertificationsTests.swift
//  Movie API
//
...
final class FetchMovieCertificationsTests: XCTestCase {

    var useCase: FetchMovieCertifications!
    var dataSource: CertificationStubDataSource!

    override func setUp() {
        super.setUp()
        dataSource = CertificationStubDataSource()
        useCase = FetchMovieCertifications(dataSource: dataSource)
    }
    ...
    func testExecute() async throws {
        ...
        dataSource.movieCertificationsResult = .success(certifications)
